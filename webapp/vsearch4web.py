...
# Thread를 사용했기 때문에 아래 함수 진행이 불가함
# do_search 함수 내부에 copy_current_request_context 장식자를 이용하여 log_request 함수를 중첩시킴
# 상세 내용은 p.511 참고
'''							
...
def do_search() -> 'html':
	...
	try:
		# log_request 호출 시 DB와 커넥팅을 하는데, 
		# 사용자 관점에서 DB 연결 시간과 코드 실행과는 관계없이 진행될 수 있도록 Thread 기법 추가
